...
class LookupApi
{
    ...
    /**
     * Operation lookupBatch
     *
     * Batch
     *
     * @param  \VPNDetection\Internal\Model\BatchLookupRequest $batch_lookup_request batch_lookup_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lookupBatch'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \VPNDetection\Internal\Model\BatchLookupResponse|\VPNDetection\Internal\Model\LookupError
     */
    public function lookupBatch(
        \VPNDetection\Internal\Model\BatchLookupRequest $batch_lookup_request,
        string $contentType = self::contentTypes['lookupBatch'][0]
    ): \VPNDetection\Internal\Model\BatchLookupResponse|\VPNDetection\Internal\Model\LookupError
    {
        list($response) = $this->lookupBatchWithHttpInfo($batch_lookup_request, $contentType);
        return $response;
    }

    /**
     * Operation lookupBatchWithHttpInfo
     *
     * Batch
     *
     * @param  \VPNDetection\Internal\Model\BatchLookupRequest $batch_lookup_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lookupBatch'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array{0: \VPNDetection\Internal\Model\BatchLookupResponse|\VPNDetection\Internal\Model\LookupError, 1: int, 2: array<string, string[]>} [response data, HTTP status code, HTTP response headers]
     */
    public function lookupBatchWithHttpInfo(
        \VPNDetection\Internal\Model\BatchLookupRequest $batch_lookup_request,
        string $contentType = self::contentTypes['lookupBatch'][0]
    ): array
    {
        $request = $this->lookupBatchRequest($batch_lookup_request, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\VPNDetection\Internal\Model\BatchLookupResponse',
                        $request,
                        $response,
                    );
                case 400:
     ...
     */
    public function lookupBatchAsync(
        \VPNDetection\Internal\Model\BatchLookupRequest $batch_lookup_request,
        string $contentType = self::contentTypes['lookupBatch'][0]
    ): PromiseInterface
    {
        return $this->lookupBatchAsyncWithHttpInfo($batch_lookup_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation lookupBatchAsyncWithHttpInfo
     *
     * Batch
     *
     * @param  \VPNDetection\Internal\Model\BatchLookupRequest $batch_lookup_request (required)
     ...
     * @return PromiseInterface
     */
    public function lookupBatchAsyncWithHttpInfo(
        \VPNDetection\Internal\Model\BatchLookupRequest $batch_lookup_request,
        string $contentType = self::contentTypes['lookupBatch'][0]
    ): PromiseInterface
    {
        $returnType = '\VPNDetection\Internal\Model\BatchLookupResponse';
        $request = $this->lookupBatchRequest($batch_lookup_request, $contentType);
    ...
    /**
     * Create request for operation 'lookupBatch'
     *
     * @param  \VPNDetection\Internal\Model\BatchLookupRequest $batch_lookup_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lookupBatch'] to see the possible values for this operation
     *
     ...
     */
    public function lookupBatchRequest(
        \VPNDetection\Internal\Model\BatchLookupRequest $batch_lookup_request,
        string $contentType = self::contentTypes['lookupBatch'][0]
    ): Request
    {
        // verify the required parameter 'batch_lookup_request' is set
        if ($batch_lookup_request === null || (is_array($batch_lookup_request) && count($batch_lookup_request) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $batch_lookup_request when calling lookupBatch'
            );
        }
        ...
        // for model (json/xml)
        if (isset($batch_lookup_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($batch_lookup_request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
                $httpBody = $batch_lookup_request;
            }
