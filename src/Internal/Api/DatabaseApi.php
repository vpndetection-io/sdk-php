...
class DatabaseApi
{
     ...
     * History
     *
     * @param  int|null $limit How many attempts to return. Clamped to 1 through 200. (optional, default to 50)
    ...
    ): Request
    {
        ...
        if ($limit !== null && $limit < 1) {
            throw new InvalidArgumentException('invalid value for "$limit" when calling DatabaseApi.listDownloads, must be bigger than or equal to 1.');
        }
