...
class Configuration
{
     ...
     * @var string
     */
    protected string $host = 'https://api.vpndetection.io';
    ...
    {
        $report  = 'PHP SDK (VPNDetection\Internal) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2026.09.03' . PHP_EOL;
