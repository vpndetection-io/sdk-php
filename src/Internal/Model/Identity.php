...
class Identity implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'rc' => 'string',
        'user' => '\VPNDetection\Internal\Model\AccountUser',
        'org' => '\VPNDetection\Internal\Model\AccountOrgRef',
        'scopes' => 'string[]'
    ];
     ...
     * Gets user
     *
     * @return \VPNDetection\Internal\Model\AccountUser
     */
    public function getUser(): \VPNDetection\Internal\Model\AccountUser
    {
     ...
     * Sets user
     *
     * @param \VPNDetection\Internal\Model\AccountUser $user user
     *
     * @return $this
     */
    public function setUser(\VPNDetection\Internal\Model\AccountUser $user): static
    {
        if (is_null($user)) {
     ...
     * Gets org
     *
     * @return \VPNDetection\Internal\Model\AccountOrgRef
     */
    public function getOrg(): \VPNDetection\Internal\Model\AccountOrgRef
    {
     ...
     * Sets org
     *
     * @param \VPNDetection\Internal\Model\AccountOrgRef $org org
     *
     * @return $this
     */
    public function setOrg(\VPNDetection\Internal\Model\AccountOrgRef $org): static
    {
        if (is_null($org)) {
     ...
     * Sets scopes
     *
     * @param string[] $scopes What this credential may do right now.
     *
     * @return $this
     */
