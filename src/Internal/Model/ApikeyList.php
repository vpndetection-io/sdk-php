...
class ApikeyList implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ApikeyList';
    ...
    protected static array $openAPITypes = [
        'rc' => 'string',
        'keys' => '\VPNDetection\Internal\Model\ApikeyDetail[]'
    ];
     ...
     * Gets keys
     *
     * @return \VPNDetection\Internal\Model\ApikeyDetail[]
     */
     ...
     * Sets keys
     *
     * @param \VPNDetection\Internal\Model\ApikeyDetail[] $keys keys
     *
     * @return $this
     */
