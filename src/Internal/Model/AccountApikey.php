...
/**
 * AccountApikey Class Doc Comment
 *
 ...
 */
class AccountApikey implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AccountApikey';
