 ...
 */
class DbChecksums implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'DbChecksums';
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['sha512'] === null) {
            $invalidProperties[] = "'sha512' can't be null";
        }
     ...
     * @return $this
     */
    public function setSha512(string $sha512): static
    {
        if (is_null($sha512)) {
