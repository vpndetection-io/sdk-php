...
class Download implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * Sets bytes
     *
     * @param int|null $bytes Object size at redirect time, NOT bytes delivered: the transfer is a presigned redirect straight to object storage, so we never observe it. int64 for the same reason as DatabaseFormatSize.bytes - it is the size of the same object.
     *
     * @return $this
     */
