...
/**
 * AccountCreatedApikey Class Doc Comment
 *
 * @package  VPNDetection\Internal
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AccountCreatedApikey implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AccountCreatedApikey';
     ...
     * Sets key
     *
     * @param string $key The secret. Returned once, here, and never again.
     *
     * @return $this
     */
     ...
     * Sets allowed_cidrs
     *
     * @param string[]|null $allowed_cidrs allowed_cidrs
     *
     * @return $this
     */
