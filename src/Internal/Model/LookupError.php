 ...
 */
class LookupError implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'LookupError';
     ...
     * Sets error
     *
     * @param string $error A human-readable explanation of the failure.
     *
     * @return $this
     */
