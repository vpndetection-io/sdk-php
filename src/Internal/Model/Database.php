 ...
 *
 * @description One database FAMILY your organization is licensed for. A license covers the family, while a download names a specific version, so the ids you pass to the download and checksum endpoints come from &#x60;versions&#x60;.
 * @package  VPNDetection\Internal
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Database implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'Database';
    ...
    protected static array $openAPITypes = [
        ...
        'in_term' => 'bool',
        'standing' => '\VPNDetection\Internal\Model\Standing',
        'versions' => '\VPNDetection\Internal\Model\DatabaseVersion[]'
    ];
     ...
     * Sets base
     *
     * @param string $base The database family, e.g. `vpn_ip`. What the license is held against.
     *
     * @return $this
     */
     ...
     * Gets standing
     *
     * @return \VPNDetection\Internal\Model\Standing
     */
    public function getStanding(): \VPNDetection\Internal\Model\Standing
    {
     ...
     * @return $this
     */
    public function setStanding(\VPNDetection\Internal\Model\Standing $standing): static
    {
        if (is_null($standing)) {
     ...
     * Gets versions
     *
     * @return \VPNDetection\Internal\Model\DatabaseVersion[]
     */
     ...
     * Sets versions
     *
     * @param \VPNDetection\Internal\Model\DatabaseVersion[] $versions Every published version of this family. The `id` here is what the download and checksum endpoints take.
     *
     * @return $this
     */
