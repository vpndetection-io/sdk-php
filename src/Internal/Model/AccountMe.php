 ...
 */
class AccountMe implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'AccountMe';
    ...
    protected static array $openAPITypes = [
        'org_id' => 'string',
        'apikey' => '\VPNDetection\Internal\Model\AccountApikey',
        'plan' => '\VPNDetection\Internal\Model\AccountPlan',
        'usage' => '\VPNDetection\Internal\Model\AccountUsage'
    ];
     ...
     * Gets apikey
     *
     * @return \VPNDetection\Internal\Model\AccountApikey
     */
    public function getApikey(): \VPNDetection\Internal\Model\AccountApikey
    {
     ...
     * Sets apikey
     *
     * @param \VPNDetection\Internal\Model\AccountApikey $apikey apikey
     *
     * @return $this
     */
    public function setApikey(\VPNDetection\Internal\Model\AccountApikey $apikey): static
    {
        if (is_null($apikey)) {
     ...
     * Gets plan
     *
     * @return \VPNDetection\Internal\Model\AccountPlan
     */
    public function getPlan(): \VPNDetection\Internal\Model\AccountPlan
    {
     ...
     * Sets plan
     *
     * @param \VPNDetection\Internal\Model\AccountPlan $plan plan
     *
     * @return $this
     */
    public function setPlan(\VPNDetection\Internal\Model\AccountPlan $plan): static
    {
        if (is_null($plan)) {
     ...
     * Gets usage
     *
     * @return \VPNDetection\Internal\Model\AccountUsage
     */
    public function getUsage(): \VPNDetection\Internal\Model\AccountUsage
    {
     ...
     * Sets usage
     *
     * @param \VPNDetection\Internal\Model\AccountUsage $usage usage
     *
     * @return $this
     */
    public function setUsage(\VPNDetection\Internal\Model\AccountUsage $usage): static
    {
        if (is_null($usage)) {
